      ...
      <div>
        ...
        <div>
          ...
          <div className={styles.recordsContainer}>
            {events.map((event) => (
              <div key={event.Id} className={styles.record}>
                <div className={styles.recordField}>{event.Event}</div>
                <div className={styles.recordField}>{event.Description}</div>
                <div className={styles.recordField}>{event.Date.toDateString()}</div>
                {event.ImgUrl && (
